...
// app.use(
//   cors({
//     origin: ["http://localhost:5173","http://localhost:5174",'https://module-52-dragon-3792f.web.app','https://module-52-dragon-3792f.firebaseapp.com'],
//   })
// );
app.use(cors());
...
async function run() {
  try {
    ...
    const userCollection = client.db("craftDB").collection("craft");
    const userEmailPass = client.db("userDB").collection("user");
